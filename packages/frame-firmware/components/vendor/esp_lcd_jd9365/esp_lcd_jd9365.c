/* Old_Panel revision of the vendor's JD9365 driver.
 * The two shell revisions ship different init sequences (197 vs 204 command
 * entries). The New_Panel sequence leaves this board's panel answering ID
 * queries but not rendering video, which is what sent us down a long false
 * trail. See docs/Hardware-Reference.md.
 */
/*
